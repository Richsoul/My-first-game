...
#### Objective
The goal of "Treausre Hunt" game is to control a diver to collect dropped/lost items on the bottom of the lake. Depending on the initial cost and state of founded item, player exchanges it to money equivalent at the end of each level; then money could be spend to buy new, more specialized equipement, that will improve his dive experience. On his way the diver will meet variaty of obstacles: fishing nets, boats, seaweed, etc.

#### Gameplay Mechanics
The game is infinite runner(swimmer), where player controls the diver with press and hold action. The control action will make diver swim deeper to the bottom of the lake to collect items(each item kind has its own value). The erned money could be spend on power ups. You cen either refill your current oxygen level by 20% or gain ivulrenability for 3 sseconds against any obstacles. On his way the diver will meet number of obstacles that will somehow affect his performance. He can be stuck inside fishing net, or seaweed which will pull him even deeper into the water, forcing player to return to the surface; when hit by front part of the boat, it will push him outside of the screen, which will result diver's death; when hit by boat's engine, he looses 10% of current oxygen level and bouncec off of it. Fishing net roots for 2 seconds, disallowing him to swim up; seaweed roots for the whole time diver spend inside, decreasing his speed in all directions by 50%. The oxygen level is automatialy re-filled, while the diver remains on water's surface. Boats' appearence will be alarmed three seconds ahead. The other alarm warns the player to fill the oxigen, while under 15% mark. The round will end when the diver runs out of oxygen or goes out off the screen.
